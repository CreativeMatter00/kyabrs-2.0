...
const NavTest = () => {
  ...
  return (
    <div className="flex flex-col z-[100000] mt-0.5">
      <div
        className={`fixed bg-gradient-to-b from-[#333739] opacity-100 inset-0 z-10 h-40 top-0  ${
          pathName === "/" || pathName === "/test-mahfuz" ? "block" : "hidden"
        } `}
      ></div>
                  ...
                  <div className="container mx-auto  relative ">
                    <div className="flex items-center justify-between text-[#F5F5F5]  ">
                      ...
                      <div className={`flex flex-col max-lg:hidden  `}>
                        ...
                        >
                          <div className="flex items-center justify-end font-bold text-sm  py-2 px-4 divide-x">
