...
const achievementsData = [
	{
		...
		description:
			"KYAMCH-BRS successfully completed a Phase III clinical trial leading to the approval of a new cancer therapy. This breakthrough offers hope to thousands of patients.",
	...
	},
	{
		...
		description:
			"KYAMCH-BRS received a prestigious award for outstanding community outreach and education efforts, highlighting our commitment to public health awareness.",
		imageSrc: "/assets/images/home/RUM1153 3.png",
		tags: ["Community Engagement", "Public Health", "Education"],
	},
	{
		title: "First Hospital-Affiliated Bio-Research Organization",
		description:
			"We are proud to be the first hospital-affiliated bio-research organization in Bangladesh, enabling seamless integration of clinical practice and research.",
								...
								{achievementsData.map((achievement, index) => (
									...
									>
										<Image
											...
											width={306}
											alt="achievements"
											className={`rounded-lg h-[310px] w-[306px] max-md:hidden ${
												index === 3 && "ml-8"
											}`}
										/>
