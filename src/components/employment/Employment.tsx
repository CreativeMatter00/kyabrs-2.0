        ...
        <div className="container p-8 flex flex-col gap-8">
          <div>
            ...
            <p className="text-bgPrimary">
              ...
              looking for passionate and talented individuals to join our team.
              If you are dedicated to excellence in clinical research and want
              to be part of a pioneering organization, we invite you to explore
