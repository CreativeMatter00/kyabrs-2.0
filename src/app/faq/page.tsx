				...
				<Accordion type="single" collapsible className="w-full">
					<AccordionItem value="item-1">
						...
						<AccordionContent className="text-base">
							KYAMCH-BRS is a research organization in Bangladesh that offers
					...
					<AccordionItem value="item-3">
						...
						<AccordionContent className="text-base">
							...
							applications should review our guidelines and procedures.
							Proposals are typically evaluated based on scientific merit,
							feasibility, and alignment with our research priorities.
						</AccordionContent>
					</AccordionItem>
