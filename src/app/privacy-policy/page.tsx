					...
					<div className="pb-8">
						...
						<ul className="font-medium ml-8 text-lg list-inside list-disc">
							...
							<li className="">
								...
								"Our" in this Agreement) refers to Khwaja Yunus Ali Medical
								College & Hospital Bioresearch Services, Enayetpur, Sirajganj,
								Bangladesh
							</li>
							<li className="">
							...
							<li className="">
								...
								<Link href="https://www.kyabrs.org/">
									https://www.kyabrs.org/
								</Link>
							</li>
							<li className="">
