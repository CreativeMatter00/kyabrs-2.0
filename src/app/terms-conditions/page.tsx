		...
		<div className="container mx-auto mt-24 lg:mt-32 py-12">
			...
			<div className="text-lg mb-8">
				<p>
					...
					property rights are reserved. You may access this from KYAMCH-BRS for
				...
				<p>
					...
					Khwaja Yunus Ali Medical College & Hospital Bio-Research Services does
					...
					Khwaja Yunus Ali Medical College & Hospital Bio-Research Services, its
					...
					by applicable laws, Khwaja Yunus Ali Medical College & Hospital
					Bio-Research Services shall not be liable for the Comments or for any
			...
			<div className="text-lg mb-8">
				...
				<p>
					...
					the hyperlink compensates the absence of Khwaja Yunus Ali Medical
					College & Hospital Bio-Research Services; and (d) the link is in the
				...
				<p>
					...
					Services's logo or other artwork will be allowed for linking absent a
