	...
	return (
		<div className="container mx-auto mt-24 lg:mt-32 py-12">
			...
			<div className="text-lg">
				<p>Welcome to KYABRS!</p>
				<br />

				<p>
					These terms and conditions outline the rules and regulations for the
					use of Khwaja Yunus Ali Bio-Research Services Website, located at
					kyabrs.org.
				</p>
				<br />
				...
				<p>
					...
					conditions. Do not continue to use KYABRS if you do not agree to take
				...
				<p>
					...
					accordance with and subject to, prevailing law of bd. Any use of the
			...
			<div className="text-lg mb-8">
				<p>
					We employ the use of cookies. By accessing KYABRS, you agreed to use
					cookies in agreement with the Khwaja Yunus Ali Bio-Research Services's
					Privacy Policy.
				</p>
			...
			<div className="text-lg mb-8">
				<p>
					Unless otherwise stated, Khwaja Yunus Ali Bio-Research Services and/or
					its licensors own the intellectual property rights for all material on
					KYABRS. All intellectual property rights are reserved. You may access
					this from KYABRS for your own personal use subjected to restrictions
				...
				<ul className="list-disc list-inside">
					<li>Republish material from KYABRS</li>
					<li>Sell, rent or sub-license material from KYABRS</li>
					<li>Reproduce, duplicate or copy material from KYABRS</li>
					<li>Redistribute content from KYABRS</li>
				</ul>
				...
				<p>
					...
					Khwaja Yunus Ali Bio-Research Services does not filter, edit, publish
					or review Comments prior to their presence on the website. Comments do
					not reflect the views and opinions of Khwaja Yunus Ali Bio-Research
					Services, its agents and/or affiliates. Comments reflect the views and
					opinions of the person who post their views and opinions. To the
					extent permitted by applicable laws, Khwaja Yunus Ali Bio-Research
					Services shall not be liable for the Comments or for any liability,
				...
				<p>
					Khwaja Yunus Ali Bio-Research Services reserves the right to monitor
				...
				<p>
					You hereby grant Khwaja Yunus Ali Medical College &amp; Hospital a
			...
			<div className="text-lg mb-8">
				...
				<p>
					...
					the hyperlink compensates the absence of Khwaja Yunus Ali Bio-Research
				...
				<p>
					...
					sending an e-mail to Khwaja Yunus Ali Bio-Research Services. Please
				...
				<p>
					No use of Khwaja Yunus Ali Bio-Research Services's logo or other
