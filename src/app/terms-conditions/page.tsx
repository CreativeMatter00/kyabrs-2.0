...
const page = () => {
	return (
		<div className="bg-brandSecondary text-bgPrimary">
			<div className="container mx-auto mt-24 lg:mt-28 px-4 py-12">
				...
				<div className="text-base">
					...
					<p>
						...
						Services Website, located at kyabrs.org.
					</p>
					<br />

					<p>
						By accessing this website we assume you accept these terms and
						conditions. Do not continue to use KYAMCH-BRS if you do not agree to
					...
					<p>
						...
						subject to, prevailing law of bd. Any use of the above terminology
				...
				<div className="text-base mb-8">
					<p>
						...
						Hospital Bio-Research Services's Privacy Policy.
					</p>
				...
				<div className="text-base mb-8">
					<p>
						...
						property rights for all material on KYAMCH-BRS. All intellectual
						property rights are reserved. You may access this from KYAMCH-BRS
					...
					<ul className="list-disc list-inside">
						<li>Republish material from KYAMCH-BRS</li>
						<li>Sell, rent or sub-license material from KYAMCH-BRS</li>
						<li>Reproduce, duplicate or copy material from KYAMCH-BRS</li>
						<li>Redistribute content from KYAMCH-BRS</li>
					</ul>
					...
					<p>
						...
						opinions of Khwaja Yunus Ali Medical College & Hospital Bio-Research
						Services, its agents and/or affiliates. Comments reflect the views
						and opinions of the person who post their views and opinions. To the
						extent permitted by applicable laws, Khwaja Yunus Ali Medical
						College & Hospital Bio-Research Services shall not be liable for the
				...
				<div className="text-base mb-8">
					...
					<p>
						...
						visibility of the hyperlink compensates the absence of Khwaja Yunus
						Ali Medical College & Hospital Bio-Research Services; and (d) the
					...
					<p>
						...
						sending an e-mail to Khwaja Yunus Ali Medical College & Hospital
						Bio-Research Services. Please include your name, your organization
					...
					<p>
						No use of Khwaja Yunus Ali Medical College & Hospital Bio-Research
						Services's logo or other artwork will be allowed for linking absent
